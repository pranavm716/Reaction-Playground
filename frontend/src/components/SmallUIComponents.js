...
export const openExternalIcon = <svg style={{
    marginLeft: '15px',
    position: 'relative',
...
export const copyIcon = <svg style={{
    marginLeft: '15px',
    position: 'relative',
}} xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
...
export const BackButton = ({ text, onClick }) => {
    return (
        <button onClick={onClick ? onClick : undefined} style={{ height: '34px', marginTop: '20px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '5px' }} className="primary-colored-button">
            <svg xmlns="http://www.w3.org/2000/svg" height="23px" viewBox="0 -960 960 960" width="24px" fill="#fff">
